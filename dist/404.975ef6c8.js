...
var _multilang = require("./multilang");
var _multilangDefault = parcelHelpers.interopDefault(_multilang);
class Index {
    constructor(){
        this.init();
    }
    init() {
        ...
        //     loadInvisible: true,
        // })
        new (0, _multilangDefault.default)();
    }
}
exports.default = Index;
new Index();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./multilang":"93tue"}],"gkKU3":[function(require,module,exports) {
...
},{}],"93tue":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class Multilang {
    ...
    init() {
        this.textHeight();
        window.addEventListener("resize", (0, _debounceThrottle.tf_debounce)((e)=>{
            this.textHeight();
        }, 500));
        this.multilang();
    }
    textHeight() {
        if (this.DOM.paragraph) this.DOM.paragraph.forEach((section)=>{
...
},{"gsap":"fPSuC","gsap/ScrambleTextPlugin":"4SFGB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","@andresclua/debounce-throttle":"ioBad"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4SFGB":[function(require,module,exports) {
/*!
...
var ScrambleTextPlugin = {
    ...
    init: function init(target, value, tween, index, targets) {
        ...
        data.original = (0, _stringsJs.emojiSafeSplit)((0, _stringsJs.getText)(target).replace(_spacesExp, " ").split("&nbsp;").join(""), delim, trim);
        if (text === "{original}" || text === true || text == null) text = data.original.join(delim);
        data.text = (0, _stringsJs.emojiSafeSplit)((text || "").replace(_spacesExp, " "), delim, trim);
        data.hasClass = !!(value.newClass || value.oldClass);
        data.newClass = value.newClass;
        data.oldClass = value.oldClass;
        splitByChars = delim === "";
        data.textHasEmoji = splitByChars && !!data.text.emoji;
        data.charsHaveEmoji = !!value.chars && !!(0, _stringsJs.emojiSafeSplit)(value.chars).emoji;
    ...
    render: function render(ratio, data) {
        ...
        if (revealDelay) {
            if (tween._from) time = tween._dur - time; //invert the time for from() tweens
        ...
        if (rightToLeft) {
            if (ratio === 1 && (tween._from || tween.data === "isFromStart")) {
                ...
                if (charsHaveEmoji) startText = (0, _stringsJs.emojiSafeSplit)(endText).slice(0, position - (textHasEmoji ? (0, _stringsJs.emojiSafeSplit)(str) : str).length + 0.5 | 0).join("");
                else startText = endText.substr(0, position - (textHasEmoji ? (0, _stringsJs.emojiSafeSplit)(str) : str).length + 0.5 | 0);
                endText = str;
            }
        } else {
            startText = text.slice(0, i).join(delimiter);
            i2 = (textHasEmoji ? (0, _stringsJs.emojiSafeSplit)(startText) : startText).length;
            if (charsHaveEmoji) endText = (0, _stringsJs.emojiSafeSplit)(endText).slice(i2, position + 0.5 | 0).join("");
            else endText = endText.substr(i2, position - i2 + 0.5 | 0);
        }
        if (hasClass) {
...
ScrambleTextPlugin.emojiSafeSplit = (0, _stringsJs.emojiSafeSplit);
ScrambleTextPlugin.getText = (0, _stringsJs.getText);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ioBad":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequire483d")
